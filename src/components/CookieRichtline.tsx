  ...
  return (
    <div className="py-24 bg-white min-h-screen">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-8">
        <h1 className="text-4xl font-extrabold text-black sm:text-5xl tracking-tight uppercase mb-8 text-left">Cookie-Richtlinie</h1>
        
        <div className="space-y-8 text-neutral-600 font-light leading-relaxed">
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Was sind Cookies?</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Welche Arten von Cookies verwenden wir?</h2>
            
            <h3 className="text-lg font-bold text-neutral-900 mt-4">Notwendige Cookies</h3>
            ...
            <h3 className="text-lg font-bold text-neutral-900 mt-4">Funktionale Cookies</h3>
            ...
            <h3 className="text-lg font-bold text-neutral-900 mt-4">Analyse- und Statistik-Cookies</h3>
            ...
            <h3 className="text-lg font-bold text-neutral-900 mt-4">Marketing-Cookies</h3>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Rechtsgrundlage</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Verwaltung Ihrer Cookie-Einstellungen</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Cookies von Drittanbietern</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#1c2e4a] mb-4 tracking-tight uppercase">Änderungen dieser Cookie-Richtlinie</h2>

  ...
  return (
    <div className="py-24 bg-white min-h-screen">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-8">
        <h1 className="text-4xl font-extrabold text-[#101d33] sm:text-5xl tracking-tight uppercase mb-8 text-left">Datenschutzerklärung</h1>
        
        <div className="space-y-8 text-[#1c2e4a] font-light leading-relaxed">
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">1. Datenschutz auf einen Blick</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">2. Verantwortliche Stelle</h2>
            <p>ITW EduLab</p>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">3. Erhebung und Speicherung personenbezogener Daten</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">4. Kontaktaufnahme</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">5. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">6. Hosting</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">7. Ihre Rechte</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">8. SSL- bzw. TLS-Verschlüsselung</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-[#101d33] mb-4 tracking-tight uppercase">9. Änderungen dieser Datenschutzerklärung</h2>
